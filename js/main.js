...
const arrayPistas = [
  ...
  "Es una pieza de metal o plástico que se coloca en la parte inferior de los vehículos para protegerlos.",
  ...
  "Es un vehículo que se desplaza sobre una superficie gracias a la fuerza del aire.",
  ...
  "Es un dispositivo que se utiliza para subir o bajar a diferentes niveles de un edificio de forma automática.",
  ...
  "Son una legumbre que se utiliza en diferentes platos, como el hummus y el cocido.",
  "Es un alimento rico en proteínas que se encuentra en la cáscara de las aves.",
  "Es una verdura de raíz que es rica en vitamina A y que se utiliza en diferentes platos, como las ensaladas y las sopas.",
  "Es la carne que se obtiene a partir del pollo y que se utiliza en diferentes platos, como el pollo asado y el pollo frito.",
  "Son una legumbre que se utiliza en diferentes platos, como el chili y los frijoles refritos.",
  "Suele curar a enfermos",
  "Género femenino con la que se tiene amistad",
  "Película de Disney, hay un oso",
  "Limón con azúcar",
  "Se utiliza principalmente en las cocinas",
  ...
  "Descansa en paz",
  "Mary Poppins, volando",
  "Día en que se cumple el aniversario del nacimiento de una persona",
  "Proteje las cosechas, ayuhentando",
  "Atracción de feria",
  "No es Sur, es ...",
  "Tiene cola, dos cuernos y es malo",
  "Las tienen los perros sucios",
  "Decoran el suelo",
  "Suele estar algo hasta que llega una mascota",
  "Reptil voraz de gran tamaño, color marrón",
  "Mamífero de gran tamaño, de color gris trompa",
  ...
  "Mamífero cetáceo de unos 3 metros de longitud de lomo oscuro y vientre blanquecino,",
  "Crustáceo con pinzas en sus patas delanteras",
  "Mamífero de cuerpo muy voluminoso, cabeza grande, orejas pequeñas, patas gruesas y cortas y piel gruesa que vive en los ríos y come",
  "Mamífero marino de mayor tamaño que la foca ",
  "Mamífero volador, con alas membranosas y hábitos nocturno",
  "Insecto de cuerpo alargado y patas",
  ...
  "Ave pequeña de pico corto,alas pontiagudas",
  "Insecto coleoptero que emite luz",
  "Comida que se toma al mediodía o al mediodía",
  "Suma de dos o más números o elementos.",
  ...
  "Póster o cartel publicitario impreso en papel u otro material.",
  ...
  "Aspecto externo o impresión que algo o alguien produce.",
